            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <table class="table bootstrap-datatable countries">
                  ...
                  <tbody>
                    <tr>
                      <td><img src="assets/backend/backend/img/Germany.png" style="height:18px; margin-top:-2px;"></td>
                      <td>Germany</td>
                      <td>2563</td>
                      <td>1025</td>
                      <td>
                    ...
                    <tr>
                      <td><img src="assets/backend/backend/img/India.png" style="height:18px; margin-top:-2px;"></td>
                      <td>India</td>
                      <td>3652</td>
                      <td>2563</td>
                      <td>
                    ...
                    <tr>
                      <td><img src="assets/backend/backend/img/Spain.png" style="height:18px; margin-top:-2px;"></td>
                      <td>Spain</td>
                      <td>562</td>
                      <td>452</td>
                      <td>
                  ...
                  <ul class="chats">
                    ...
                    <li class="by-me">
                      ...
                      <div class="avatar pull-left">
                        <img src="assets/backend/backend/img/user.jpg" alt="" />
                      </div>
                    ...
                    <li class="by-other">
                      ...
                      <div class="avatar pull-right">
                        <img src="assets/backend/backend/img/user22.png" alt="" />
                      </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <span class="profile-ava pull-right">
                                        <img alt="" class="simple" src="assets/backend/backend/img/avatar1_small.jpg">
                                        Jenifer smith
                                </span>
                  </div>
                </div>
